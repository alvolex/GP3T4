...
template<> FMODSTUDIO_API UScriptStruct* StaticStruct<FFMODLocalizedBankTable>()
{
	...
	struct Z_CompiledInDeferFile_FID_GP3T4_Plugins_FMODStudio_Source_FMODStudio_Private_FMODBankLookup_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GP3T4_Plugins_FMODStudio_Source_FMODStudio_Private_FMODBankLookup_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GP3T4_Plugins_FMODStudio_Source_FMODStudio_Private_FMODBankLookup_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GP3T4_Plugins_FMODStudio_Source_FMODStudio_Private_FMODBankLookup_h_1812449671(TEXT("/Script/FMODStudio"),
		Z_CompiledInDeferFile_FID_GP3T4_Plugins_FMODStudio_Source_FMODStudio_Private_FMODBankLookup_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_GP3T4_Plugins_FMODStudio_Source_FMODStudio_Private_FMODBankLookup_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_GP3T4_Plugins_FMODStudio_Source_FMODStudio_Private_FMODBankLookup_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_GP3T4_Plugins_FMODStudio_Source_FMODStudio_Private_FMODBankLookup_h_Statics::ScriptStructInfo),
		nullptr, 0);
